...
<html lang="en">
  <head>
    ...
    <style>
        ...
        body {
            font-family: 'Poppins', sans-serif; background-color: #F4F2F9; 
            color: #2D3748; margin: 0; overflow-x: hidden;
        }

        /* Sidebar Styling (Same across all views) */
        .sidebar {
        ...
        .top-header {
            ...
            margin-bottom: 2rem; background: white; padding: 1rem 2rem; 
        ...
        /* Forms */
        .form-control {
            border-radius: 12px; padding: 12px 18px; border: 1px solid #E2E8F0;
            background: #F8F9FA; font-weight: 500; font-size: 0.95rem;
        }
        .form-control:focus {
            border-color: #8749f5; box-shadow: 0 0 0 3px rgba(135, 73, 245, 0.15); background: white;
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="student-create.php" class="active"><span><i class="fas fa-user-plus"></i></span> Add Student</a>
    ...
    <div class="main-wrapper">
        ...
        <!-- Top Header for spacing consistency -->
        <div class="top-header">
            <h5 class="mb-0 fw-bold text-muted">Registration Management</h5>
        </div>
                    ...
                    <div class="card-body">
                        <form action="code.php" method="POST">
                            ...
                            <div class="mb-3 mt-4 text-end">
                                <button type="submit" name="save_student" class="btn btn-primary px-5">Save Student</button>
                            </div>
