...
<html lang="en">
  <head>
    ...
    <style>
        ...
        /* View Data Styling */
        .view-group { background: #F8F9FA; padding: 15px 20px; border-radius: 15px; margin-bottom: 20px; border: 1px solid #f0f0f0; }
        label { font-weight: 600; color: #A0AEC0; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px; }
        .view-data { font-size: 1.1rem; font-weight: 600; color: #2D3748; margin: 0; }
        
        /* Avatar placeholder */
        .profile-avatar { 
            width: 100px; height: 100px; background: #e9d5ff; color: #6b21a8;
            border-radius: 30px; display: flex; align-items: center; justify-content: center;
            font-size: 40px; font-weight: bold; margin: 0 auto 2rem auto;
...
<body>
    ...
    <div class="main-wrapper">
        <div class="top-header">
            <h5 class="mb-0 fw-bold text-muted">Personal Info</h5>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="view-group">
                                                ...
                                                <p class="view-data"><?=$student['name'];?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="view-group">
                                                <label>Student Email</label>
                                                <p class="view-data"><?=$student['email'];?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="view-group">
                                                <label>Student Phone</label>
                                                <p class="view-data"><?=$student['phone'];?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="view-group">
                                                ...
                                                <p class="view-data">
                                                    <span class="badge" style="background: #e9d5ff; color: #6b21a8; font-size: 1rem; padding: 5px 10px; border-radius: 8px;">
                                                        <?=$student['course'];?>
                                                    </span>
                                                </p>
                                            </div>
